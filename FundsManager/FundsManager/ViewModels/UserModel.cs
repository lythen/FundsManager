...
namespace FundsManager.ViewModels
{
    ...
    {
        [StringLength(20),DisplayName("真实姓名")]
        ...
        [StringLength(200), DisplayName("电子邮箱")]
        public string email { get; set; }
        [StringLength(16), DisplayName("登陆密码")]
        public string password { get; set; }
        [StringLength(16), DisplayName("确认密码")]
        ...
        public void toUserInfoDB(User_Info model)
        {
            ...
            model.user_password = PageValidate.InputText(password, 16);
        ...
        public void toUserExtendDB(User_Extend model)
        {
            ...
            model.user_office_phone = PageValidate.InputText(officePhone, 20);
            model.user_picture = PageValidate.InputText(picture, 20);
